...
#define WHITE   GAME::Color(255, 255, 255, 255)
#define GRAY    GAME::Color(128, 128, 128, 255)
#define BLACK   GAME::Color(  0,   0,   0, 255)
#define RED     GAME::Color(255,   0,   0, 255)
#define GREEN   GAME::Color(  0, 255,   0, 255)
#define BLUE    GAME::Color(  0,   0, 255, 255)
#define MAGENTA GAME::Color(255,   0, 255, 255)
#define YELLOW  GAME::Color(255, 255,   0, 255)
#define CYAN    GAME::Color(  0, 255, 255, 255)

bool GAME::mesh_utils::loadOBJ(GAME::Mesh &mesh, const char* filename) {
    ...
    std::unordered_map<GAME::Vertex, GLuint> vertex_map;
    ...
    mesh.create({GAME::setup_buffer_accessors<Vertex>});
...
void GAME::mesh_utils::Cuboid(Mesh& mesh,
            bool colored_faces,
...
void GAME::mesh_utils::Sphere(GAME::Mesh& mesh, const glm::ivec2& segments, bool colored,
    ...
    for(int lat = 0; lat <= segments.y; lat++){
        ...
        for(int lng = 0; lng <= segments.x; lng++){
            ...
            GAME::Color color = colored ? GAME::Color(127.5f * (normal + 1.0f), 255) : WHITE;
...
void GAME::mesh_utils::Plane(GAME::Mesh& mesh, const glm::ivec2& resolution, bool colored,
    ...
    for(it.x = 0; it.x <= resolution.x; it.x++){
        ...
        for(it.y = 0; it.y <= resolution.y; it.y++){
            ...
            GAME::Color color = colored ? glm::mix(
                    glm::mix(GAME::Color(255, 0, 0, 255), GAME::Color(0, 255, 0, 255), uv.s),
                    glm::mix(GAME::Color(255, 255, 0, 255), GAME::Color(0, 0, 255, 255), uv.s),
                    uv.t) : WHITE;
