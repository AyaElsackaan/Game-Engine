...
glm::ivec2 GAME::texture_utils::loadImage(GLuint texture, const char *filename, bool generate_mipmap) {
    glm::ivec2 size;
    int channels;
...
glm::ivec2 GAME::texture_utils::loadImageGrayscale(GLuint texture, const char *filename, bool generate_mipmap) {
    glm::ivec2 size;
    int channels;
    //Since OpenGL puts the texture origin at the bottom left while images typically has the origin at the top left,
    //We need to till stb to flip images vertically after loading them
...
void GAME::texture_utils::singleColor(GLuint texture, GAME::Color color, glm::ivec2 size){
...
void GAME::texture_utils::checkerBoard(GLuint texture, glm::ivec2 size, glm::ivec2 patternSize, GAME::Color color1, GAME::Color color2){
    auto* data = new GAME::Color[size.x * size.y];
    int ptr = 0;
